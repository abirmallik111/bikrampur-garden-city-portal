...
export const SocietyDirectoryPage: React.FC = () => {
  ...
  const emergencyContacts = [
    ...
    { name: 'ধোলাইরপাড় পুলিশ ফাঁড়ি / শ্যামপুর থানা', phone: '01713-373155', icon: Shield, type: 'Police' },
      ...
      <div className="bg-gradient-to-r from-[#1e3a5f] to-[#122842] text-white p-6 sm:p-10 rounded-3xl shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div className="space-y-3 flex-1">
          ...
          <p className="text-xs sm:text-sm text-slate-200 max-w-2xl leading-relaxed">
            বিক্রমপুর গার্ডেন সিটি (৪৪২ ধোলাইরপাড়, ঢাকা-মাওয়া মহাসড়ক)-এর বর্তমান আহ্বায়ক কমিটি, নির্বাচিত কার্যনির্বাহী পরিষদ ও স্থানীয় জরুরি সেবাসমূহ।
          </p>
        </div>
        <img
          src="/logo.png"
            ...
            <div className="flex items-start sm:items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 max-w-2xl leading-relaxed">
                  ৪৪২ ধোলাইরপাড়, ঢাকা-মাওয়া মহাসড়ক, ঢাকা-১২০৪ • সকল স্থায়ী সদস্য, সহযোগী নিবাসী, ভাড়াটিয়া ও সংশ্লিষ্ট সকলের জন্য বাধ্যতামূলক
                </p>
              </div>
            </div>
                  ...
                  printWin.document.write(`
                    ...
                    <body>
                      <div class="header">
                        ...
                        <h2>সংগঠনের গঠনতন্ত্র ও নীতিমালা • ৪৪২ ধোলাইরপাড়, ঢাকা-মাওয়া মহাসড়ক, ঢাকা</h2>
                      ...
                      <div class="article">
                        ...
                        <div class="article-body">
                          ...
                          <p><strong>১.২ এখতিয়ার এলাকা:</strong> ৪৪২ ধোলাইরপাড়, ঢাকা-মাওয়া মহাসড়ক সংলগ্ন আবাসিক সোসাইটির আওতাধীন সকল প্লট, ভবন, ফ্ল্যাট, অভ্যন্তরীণ রাস্তা, ড্রেন, পার্কিং এলাকা, কেন্দ্রীয় জামে মসজিদ, সোসাইটি কমিউনিটি সেন্টার ও সাধারণ সুবিধাসমূহ।</p>
            ...
            {(bylawsChapter === 'all' || bylawsChapter === 'admin') && (
              <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-2xs space-y-3">
                ...
                <div className="space-y-2 text-slate-600">
                  <p><strong>১.১ পূর্ণ নাম:</strong> বিক্রমপুর গার্ডেন সিটি কল্যাণ সমিতি (সোসাইটি)।</p>
                  <p><strong>১.২ এখতিয়ার এলাকা:</strong> ৪৪২ ধোলাইরপাড়, ঢাকা-মাওয়া মহাসড়ক সংলগ্ন আবাসিক সোসাইটির আওতাধীন সকল প্লট, ভবন, ফ্ল্যাট, অভ্যন্তরীণ রাস্তা, ড্রেন, পার্কিং এলাকা, কেন্দ্রীয় জামে মসজিদ, কমিউনিটি সেন্টার ও সাধারণ সুবিধাসমূহ।</p>
                  <p><strong>১.৩ সংগঠনের স্বরূপ:</strong> এটি সম্পূর্ণ অরাজনৈতিক, অলাভজনক, ধর্মনিরপেক্ষ এবং আবাসিক নাগরিক কল্যাণমূলক সংগঠন।</p>
